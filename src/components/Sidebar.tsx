  ...
  return (
    <ScrollArea className="flex h-full w-64 border-0 border-r border-solid border-main-border bg-main-background">
      <aside className="flex min-h-screen w-full flex-col">
        ...
        <button
          onClick={hideSidebar}
          className={`mb-2 mt-2 flex items-center gap-x-4 rounded-r-full py-3 pl-5 text-gray-400 transition-all duration-300 hover:bg-board-background hover:text-main-color`}
        >
